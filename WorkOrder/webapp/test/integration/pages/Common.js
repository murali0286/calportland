sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("calportland/workorder/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("calportland.workorder.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["calportland/workorder/localService/mockserver"], function (mockserver) {
