/*global history */
sap.ui.define([
        "calportland/workorder/controller/BaseController",
        "sap/ui/model/json/JSONModel",
        "sap/ui/model/Filter",
        "sap/ui/model/FilterOperator",
        "sap/m/GroupHeaderListItem",
        "sap/ui/Device",
        "calportland/workorder/model/formatter"
    ], function (BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter) {
        "use strict";

        return BaseController.extend("calportland.workorder.controller.Master", {
            ...
            onSearch: function (oEvent) {
                ...
                var oFilter = new Filter([new Filter("OrderID", FilterOperator.EQ, parseInt(sQuery)),
                        new Filter("EquipmentNumber", FilterOperator.Contains, parseInt(sQuery))],
                    false);

                if (sQuery) {
                    this._oListFilterState.aSearch = [oFilter];
                } else {
