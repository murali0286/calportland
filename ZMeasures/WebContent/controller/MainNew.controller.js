sap.ui.define([
    ...
    "calportland/measure/model/formatter"
], function (BaseController, JSONModel, MessageToast, ValueState, MessageBox, Filter, FilterOperator, formatter) {

    "use strict";
    return BaseController.extend("calportland.measure.controller.MainNew", {
        ...
        onSuggesstionItemSelected: function (oEvent) {
          if(oEvent.getParameter("selectedItem").oBindingContexts != null){
              this._oViewModel.setProperty("/CurrentData/MeasurementPointId", oEvent.getParameter("selectedItem").oBindingContexts.ViewModel.oModel.getProperty(oEvent.getParameter("selectedItem").oBindingContexts.ViewModel.getPath()).FuelMeasPointId);
          }
...
debugger;
            var oNewDoc = {
              MeasurementDocId: "00000000000000000000",
              MeasurementPointId: "000000000000",
            ...
            //Set Measurement ID
            oNewDoc.MeasurementPointId = oCurrentData.MeasurementPointId;
            //Validate Equipment Number
            if (oCurrentData.EquipmentId) {
              oNewDoc.EquipmentId = oCurrentData.EquipmentId;
            ...
            if (oCurrentData.ReadingValue) {
              oNewDoc.Value = oCurrentData.ReadingValue;
            ...
            if (oCurrentData.ReadingDate && Date.parse(oCurrentData.ReadingDate)) {
                oNewDoc.MeasurementDate = oCurrentData.ReadingDate; 
            ...
            if (oCurrentData.ReadingTime && Date.parse(oCurrentData.ReadingTime)) {
              oNewDoc.MeasurementTime = oReadingTime.getValue();
            ...
            return isFormValid ? oNewDoc : isFormValid;
        },
        /**
