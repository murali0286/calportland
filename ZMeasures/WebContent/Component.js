sap.ui.define([
		...
		"sap/ui/Device",
		"calportland/measure/model/models",
		"calportland/measure/controller/ErrorHandler"
	], function (UIComponent, Device, models, ErrorHandler) {
		"use strict";

		return UIComponent.extend("calportland.measure.Component", {

			metadata : {
				"version": "1.0.0",
				"rootView": {
					"viewName": "calportland.measure.view.App",
					"type": "XML",
					"id": "app"
				},
				"dependencies": {
				...
				"config" : {
					"i18nBundle": "calportland.measure.i18n.i18n",
					"serviceUrl": "/sap/opu/odata/sap/Z_MEASUREMENT_DOCUMENTS_SRV/",
					"icon": "",
					"favIcon": "",
					"phone": "",
					"phone@2": "",
				...
				"routing": {
					"config": {
						...
						"viewType": "XML",
						"viewPath": "calportland.measure.view",
						"controlId": "app",
					...
					"routes": [
						...
						{
							"pattern": "EquipmentCollection/{objectId}",
							"name": "object",
							"target": "object"
						}
					],
